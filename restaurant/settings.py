...
# ─── Configuración de Channels (Redis / InMemory fallback) ────────────────────
...
if redis_host == 'localhost' or redis_host == '127.0.0.1':
    ...
    CHANNEL_LAYERS = {
        'default': {
            ...
            'CONFIG': {
                "hosts": [(redis_host, int(env('REDIS_PORT', default='6379')))],
            },
        },
    }
...
# WhiteNoise: servir estáticos desde STATICFILES_DIRS sin collectstatic en desarrollo
